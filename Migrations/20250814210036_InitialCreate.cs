    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    EquinoxClassId = table.Column<int>(type: "INTEGER", nullable: false),
                    BookingSessionId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Monday", "/images/boxing101.jpg", 1, 1, "Boxing 101", "8 AM – 9 AM" },
                    { 2, 2, "Tuesday", "/images/yogaflow.jpg", 2, 2, "Yoga Flow", "6 PM – 7 PM" },
                    { 3, 3, "Wednesday", "/images/hiitblast.jpg", 3, 3, "HIIT Blast", "5 PM – 6 PM" },
                    { 4, 4, "Thursday", "/images/strengthtraining.jpg", 1, 4, "Strength Training", "7 AM – 8 AM" },
                    { 5, 5, "Friday", "/images/barrebasic.jpg", 2, 1, "Barre Basics", "9 AM – 10 AM" }
                });
